...
public class ModelLayers implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        register(CubliminalEntities.SMILER, SmilerRenderer::new, ModelLayers.SMILER, SmilerModel::getTexturedModelData);
    }
