...
public class CableTrayBlock extends Block implements Waterloggable {
    ...
    private static final VoxelShape VOXEL_SHAPE = Block.createCuboidShape(0, 10,0, 16, 14, 16);

    public CableTrayBlock(Settings settings) {
        super(settings);
    }
    ...
    protected boolean connectsTo(BlockState state) {
        return state.getBlock() instanceof CableTrayBlock;
    }
